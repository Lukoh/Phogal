...
Here is the [![alt mad-arch-overview-ui](https://developer.android.com/static/topic/libraries/architecture/images/mad-arch-overview-ui.png)](https://youtu.be/U_mvFoxypjM). 
